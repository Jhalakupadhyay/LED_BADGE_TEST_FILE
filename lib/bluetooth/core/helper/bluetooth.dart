...
import 'package:badgemagic/UI/TestScreen.dart';
...
void writeCharacteristic(
  BluetoothDevice device, Guid characteristicId, DataToSend data,BluetoothDevice bledevice) async {
...
Future scanDevice(DataToSend data) async {
