...
import 'package:badgemagic/bluetooth/core/helper/ByteArrayUtils.dart';
import 'package:flutter/material.dart';

var MAX_MESSAGES = 8;
var PACKET_START = "77616E670000";
var PACKET_BYTE_SIZE = 16;
...
List<List<int>> convert(DataToSend data) {
  assert(data.messages.length <= MAX_MESSAGES, "Max messages=$MAX_MESSAGES");

  String message = (PACKET_START +
      getFlash(data) +
      getMarquee(data) +
      getOptions(data) +
      getSizes(data) +
...
String getFlash(DataToSend data) {
...
String getMarquee(DataToSend data) {
...
String getOptions(DataToSend data) {
...
String getSizes(DataToSend data) {
  final nbMessages = data.messages.length;
  String ans = data.messages
...
String getMessage(DataToSend data) {
  String ans = data.messages
      .map((e) => e.hexStrings)
      .join()
      .split("")
